...
export interface Settings { inputMode: InputMode; muted: boolean; music: boolean; volume: number; reducedMotion: boolean; quality: 'low'|'medium'|'high'; readingTime: number; targetSpeed: number; }
